...
class SchoolParent(models.Model):
    ...
    job =fields.Char(string="Job", help="Parent's job")
    ...
    number_wifes=fields.Integer("Number of wifes")
    job_place =fields.Char("Place of Job")
    Level_of_study=fields.Char("Level of Study")
...
class ParentVisit(models.Model):
    _name = 'parent.visit'
    _description = 'Parent Visit Registration'
